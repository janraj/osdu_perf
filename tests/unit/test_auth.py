...
from azure.operations.exceptions import ClientAuthenticationError
from osdu_perf.operations.auth import AzureTokenManager
...
class TestAzureTokenManager:
    ...
    def test_logger_initialization(self):
        ...
        assert manager.logger.name == 'osdu_perf.operations.auth'
    
    @patch('osdu_perf.operations.auth.ManagedIdentityCredential')
    ...
    @patch('osdu_perf.operations.auth.AzureCliCredential')
    ...
    @patch('osdu_perf.operations.auth.DefaultAzureCredential')
    @patch('osdu_perf.operations.auth.AzureCliCredential')
...
class TestAzureTokenManagerEdgeCases:
    ...
    def test_multiple_initialization_calls(self):
        ...
        with patch('osdu_perf.operations.auth.AzureCliCredential') as mock_azure_cli:
    ...
    @patch('osdu_perf.operations.auth.logging.getLogger')
    def test_logger_configuration(self, mock_get_logger):
        ...
        mock_get_logger.assert_called_with('osdu_perf.operations.auth')
