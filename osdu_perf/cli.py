...
2. **File Name**: Must follow `perf_*_test.py` pattern for auto-discovery
...
**Generated by OSDU Performance Testing Framework v1.0.2**
'''
...
def add_custom_args(parser):
    ...
    parser.add_argument("--partition", type=str, help="OSDU Data Partition ID", required=True)
    parser.add_argument("--appid", type=str, help="Azure AD Application ID", required=True)
...
class OSDUUser(PerformanceUser):
    ...
    wait_time = None  # No wait between tasks (maximum load)
    # wait_time = between(1, 3)  # Wait 1-3 seconds between tasks (more realistic)
